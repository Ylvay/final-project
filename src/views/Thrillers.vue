<template>
    ...
    <div>
        <!-- Header -->
         <h3 class=" bg-yellow-100 px-8">Shop / Thrillers</h3>
        <h1 class="text-4xl bg-yellow-100 py-4 px-8">Thrillers</h1>
...
methods: {
    getThrillers() {
      console.log("getting thrillers")
      // Fetch thrillers from the Google Books API
      fetch(`https://books.googleapis.com/books/v1/volumes?q=thrillers&filter=paid-ebooks&key=AIzaSyCSPj1Uq2jGsYVohYexXE_43IyPeEzXkrc`)
        .then((response) => {
          if (response.ok) {
